...
func (p *Plugin) ReactionHasBeenAdded(ctx *plugin.Context, reaction *mm_model.Reaction) {
	p.boardsApp.ReactionHasBeenAdded(ctx, reaction)
}

func (p *Plugin) MessageHasBeenPosted(ctx *plugin.Context, post *mm_model.Post) {
	p.boardsApp.MessageHasBeenPosted(ctx, post)
}
