...
const BoardSelector = () => {
    ...
    if (showLinkBoardConfirmation?.channelId !== '') {
        confirmationSubText = intl.formatMessage({
            ...
            defaultMessage: 'When you link "{boardName}" to the channel, all members of the channel (existing and new) will be able to view it. This excludes members who are guests. An admin can change this default permission afterwards.{lineBreak} This board is currently linked to another channel. It will be unlinked if you choose to link it here.'
        }, {boardName: showLinkBoardConfirmation?.title, lineBreak: <p/>})
    } else {
        confirmationSubText = intl.formatMessage({
            id: 'boardSelector.confirm-link-board-subtext',
            defaultMessage: 'When you link "{boardName}" to the channel, all members of the channel (existing and new) will be able to view it. This excludes members who are guests. An admin can change this default permission afterwards. You can unlink a board from a channel at any time.'
