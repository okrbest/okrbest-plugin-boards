...
[specs/010-admin-only-card-properties/plan.md](specs/010-admin-only-card-properties/plan.md)
<!-- SPECKIT END -->
...
전문은 [constitution](.specify/memory/constitution.md)의 "개발 워크플로 > 한국어 문체".
